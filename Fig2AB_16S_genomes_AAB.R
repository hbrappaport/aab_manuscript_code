...
# load data
tax_table_its_fp = 'sourdough_tab_ITS.txt'
tax_table_16s_fp = 'sourdough_tab_16S.txt'
map_fp = 'metadata500_starters.txt'

aab_asv_tree_species = read.csv("asv_taxonomy_aab_tree.csv")
aab_genome_species = read.csv("genome_taxonomy_aab.csv")
